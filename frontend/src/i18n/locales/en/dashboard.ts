export default {
  ...
  imagePlayground: {
    ...
    ratio: 'Ratio',
    size: 'Size',
    sizePlaceholder: 'e.g. 1024x1024',
    sizeAutoHint: 'Changing resolution or ratio updates the size automatically.',
    sizeCustomHint: 'Width and height must be multiples of 16. Max edge is 3840px.',
    quality: 'Quality',
    ...
    uploadHint: 'Select multiple images or paste copied images in any field on this page. Up to 4 are kept.',
    clearImages: 'Clear images',
    clearResults: 'Clear results',
    generate: 'Generate image',
    generating: 'Generating...',
    generatingWithSeconds: 'Generating {seconds}s...',
    generatingHint: 'High-resolution images may take longer. Keep this page open.',
    result: 'Result',
    download: 'Download',
    ...
    historyTitle: 'Local generation history',
    ...
    historyImagesOmitted: 'Image data was too large or is no longer available locally; only generation parameters were saved.',
    ...
    sizeErrors: {
      format: 'Size must use WxH format, for example 1024x1024.',
      max_edge: 'The longest edge cannot exceed 3840px.',
      multiple_of_16: 'Width and height must both be multiples of 16.',
      ratio: 'The long side to short side ratio cannot exceed 3:1.',
      total_pixels: 'Total pixels cannot exceed 8,294,400.'
    },
    qualityOptions: {
      low: 'Low',
      medium: 'Medium',
