export default {
  ...
  imagePlayground: {
    ...
    sizeAutoHint: '切换清晰度或比例时会自动更新尺寸。',
    sizeCustomHint: '宽高需为 16 的倍数，最长边不超过 3840px。',
    quality: '质量',
    format: '输出格式',
    count: '输出张数',
    countOption: '{count} 张',
    inputImages: '参考图片',
    uploadTitle: '上传或粘贴图片',
    uploadHint: '支持多选图片，也可以在页面任意输入框粘贴图片；最多保留 4 张。',
    clearImages: '清空图片',
    clearResults: '清空结果',
    generate: '生成图片',
    generating: '生成中...',
    generatingWithSeconds: '生成中 {seconds}s...',
    generatingHint: '高分辨率图片可能需要更长时间，请保持页面打开。',
    result: '生成结果',
    download: '下载',
    ...
    historyImage: '历史图片',
    historyImagesOmitted: '图片数据过大或本地图片数据已失效；本条仅保留生成参数。',
    clearHistory: '清空历史',
    ...
    sizeErrors: {
      format: '尺寸格式应为 宽x高，例如 1024x1024。',
      max_edge: '最长边不能超过 3840px。',
      multiple_of_16: '宽高都必须是 16 的倍数。',
      ratio: '长短边比例不能超过 3:1。',
      total_pixels: '总像素不能超过 8,294,400。'
    },
    qualityOptions: {
      low: '低',
      medium: '中',
